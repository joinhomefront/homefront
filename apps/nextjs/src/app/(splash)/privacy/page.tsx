...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-prose py-4">
      <section className="policy" id="privacy-policy">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to We Are It LLC,
              2093 Philadelphia Pike #4030, Claymont, DE 19703.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to How Nazis Win, accessible from{" "}
              <a
                href="https://www.hownaziswin.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.hownaziswin.com
              </a>
            </p>
          </li>
          <li>
        ...
        <h3>Databases</h3>
        <p>We may use third-party Service providers to store your data.</p>
        <ul>
          <li>
            <p>
              <strong>Neon</strong>
        ...
        <ul>
          ...
          <li>
            ...
            <p>Collected: Yes.</p>
            <p>Veteran or military status, if provided.</p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>
            By email: <a href="mailto:team@wereit.app">team@wereit.app</a>
          </li>
        </ul>
        <p>
