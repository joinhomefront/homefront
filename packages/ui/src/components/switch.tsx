...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    >
      {props.checked ? <CheckIcon className="text-primary" size={16} /> : null}
    </SwitchPrimitives.Thumb>
  </SwitchPrimitives.Root>
));
    ...
    >
      ...
      >
        <Animated.View style={animatedThumbStyle}>
          <SwitchPrimitives.Thumb
            className={
              "flex h-7 w-7 items-center justify-center rounded-full bg-background shadow-md shadow-foreground/25 ring-0"
            }
          >
            {props.checked ? (
